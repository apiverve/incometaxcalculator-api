...
namespace APIVerve\Incometaxcalculator;
...
/**
 * Client for the Income Tax Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/incometaxcalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/incometaxcalculator';
    ...
    private const VALIDATION_RULES = [
        ...
        'deduction' => ['type' => 'number', 'required' => false, 'min' => 0]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\IncometaxcalculatorClient] {$message}\n";
        }
    }
}
