# Income Tax Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:incometaxcalculator-api:1.1.13'
}
```
...
```java
import com.apiverve.incometaxcalculator.IncomeTaxCalculatorAPIClient;
import com.apiverve.incometaxcalculator.APIResponse;
import com.apiverve.incometaxcalculator.APIException;

// Initialize the client
IncomeTaxCalculatorAPIClient client = new IncomeTaxCalculatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("income", 85000);
    parameters.put("filing_status", "single");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/incometaxcalculator](https://docs.apiverve.com/ref/incometaxcalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/incometaxcalculator](https://docs.apiverve.com/ref/incometaxcalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/incometaxcalculator-api/issues)
