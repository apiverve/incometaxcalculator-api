...
namespace APIVerve.API.IncomeTaxCalculator
{
    ...
    /// <summary>
    /// Client for the IncomeTaxCalculator API
    /// </summary>
    public class IncomeTaxCalculatorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/incometaxcalculator";
        ...
        {
            { "income", new ValidationRule { Type = "number", Required = true, Min = 0 } },
            { "rate", new ValidationRule { Type = "number", Required = true, Min = 0, Max = 100 } },
            { "deduction", new ValidationRule { Type = "number", Required = false, Min = 0 } }
        };
        ...
        public IncomeTaxCalculatorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public IncomeTaxCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public IncomeTaxCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, IncomeTaxCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(IncomeTaxCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(IncomeTaxCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(IncomeTaxCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(IncomeTaxCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(IncomeTaxCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(IncomeTaxCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(IncomeTaxCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(IncomeTaxCalculatorQueryOptions options)
        {
