...
class TestIncometaxcalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = IncometaxcalculatorAPIClient(self.api_key)

    @patch('apiverve_incometaxcalculator.apiClient.requests.get')
